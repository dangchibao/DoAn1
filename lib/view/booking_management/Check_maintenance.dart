      ...
      child: Column(
        children: [
          ...
          const Text(
            ...
            style: TextStyle(color: Colors.black, fontSize: mFontSize),
          ),
          const SizedBox(
            height: 10,
          ),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                DateFormat("dd/MM/yyyy").format(maintenanceModel.createdAt),
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    DateFormat("dd/MM/yyyy").format(maintenanceModel.bookingDate) +
                        " " +
                  ...
                  Text(
                    maintenanceModel.active ? "Chưa đến" : "Đã đến",
                    style: TextStyle(
                      fontSize: footnote,
                      color: maintenanceModel.active ? Colors.black : Colors.grey,
                    ),
                  ),
                  SizedBox(
                    height: space_height,
                  ...
                  Text(
                    maintenanceModel.paymentStatus == "paid" ? "Đã thanh toán" : "Chưa thanh toán",
                    style: TextStyle(
                      fontSize: footnote,
                      color: maintenanceModel.paymentStatus == "paid" ? Colors.green : Colors.red,
                    ),
                  ),
                ],
              )
